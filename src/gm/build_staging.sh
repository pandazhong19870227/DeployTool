...
ln -s $script_dir/conf/gm-staging.toml /etc/gm/conf/gm.toml
if [ $? == 0 ]; then 
    echo "ln -s $script_dir/conf/gm-staging.toml /etc/gm/conf/gm.toml succeed"
else
    echo "ln -s $script_dir/conf/gm-staging.toml /etc/gm/conf/gm.toml failed"
fi
